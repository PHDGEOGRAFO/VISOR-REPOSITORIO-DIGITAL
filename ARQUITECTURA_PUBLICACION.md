...
Durante la migración pueden mantenerse rutas históricas, especialmente `public/data`, para no romper el visor. Se reemplazarán gradualmente después de validar equivalencia.
...
## Regla de seguridad
Todo archivo que recibe el navegador debe considerarse técnicamente descargable. Un formulario, clave o botón de autorización no protege un archivo estático que ya esté publicado en GitHub Pages. Los archivos públicos deben ser seguros aun si un tercero los descarga directamente.

## Visor Territorial / Biblioteca Digital
Cada cobertura debe tener una separación explícita entre origen maestro privado y versión web/publicable. Los GeoPackage completos y archivos fuente deben permanecer en la Unidad Compartida salvo que hayan sido expresamente aprobados como producto de descarga pública y se publiquen mediante un mecanismo adecuado.
