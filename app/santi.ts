...
export function runSanti(query:string,ctx:SantiContext){
 ...
 return{summary:"Soy SANTI, asistente territorial del visor. Puedo responder conteos y nombres de barrios/territorios, consultar población n_per, activar coberturas, trabajar con Clúster, Calor, Proximidad e Isócronas y analizar todas las capas que intersectan un polígono dibujado.",actions};
}
